...
void FViewportNavigationController::ModifyFOV(float DeltaFOV)
{
	...
	NewFOV = MathUtil::Clamp(NewFOV, MathUtil::DegreesToRadians(10.f), MathUtil::DegreesToRadians(120.f));
...
void FViewportNavigationController::SetTargetLocation(const FVector& InTargetLocation)
{
